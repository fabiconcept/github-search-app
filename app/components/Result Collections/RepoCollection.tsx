...
export default function RepoCollection() {
    ...
    const { RepositoriesResults, searchQuery } = useSelector((state: RootState) => state);
    ...
    return (
        <div className="w-full relative">
            {RepositoriesResults.loading === "pending" && <div className="absolute top-0 left-0 h-full w-full z-10 bg-white/5 backdrop-blur-md grid place-items-center">
                <div role="status">
            ...
            {!(displayRepo.length > 0) && <div className="grid place-items-center p-8 gap-4 opacity-70 h-[20rem]object">
                <Image
            ...
            {!!(displayRepo.length > 0) && RepositoriesResults.response && RepositoriesResults.response.total_count > 10 && <div className="flex items-center justify-center gap-1 mt-6 text-xs">
